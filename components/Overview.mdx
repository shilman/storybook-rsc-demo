...
To mock the Rest API, we use the [`msw-storybook-addon`](https://storybook.js.org/addons/msw-storybook-addon), a thin wrapper around [`msw`](https://mswjs.io/). Note that this is using `2.0.0--canary.122.06f0c92.0` of the addon, which is compatible with [MSW 2.x](https://mswjs.io/blog/introducing-msw-2.0/).
